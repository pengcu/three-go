...
------------------------------------------ */
export const rand = (min, max, ease) => {
  if (max === undefined) {
    max = min;
    min = 0;
  }
...
| with the option of easing bias.
------------------------------------------ */
export const randInt = (min, max, ease) => {
  if (max === undefined) {
    max = min;
    min = 0;
  }
...
export const lerp = (current, target, mix) => {
...
------------------------------------------ */
export const roundToUpperInterval = (value, interval) => {
  if (value % interval === 0) {
    value += 0.0001;
  }
...
------------------------------------------ */
export const roundToLowerInterval = (value, interval) => {
  if (value % interval === 0) {
    value -= 0.0001;
  }
...
------------------------------------------ */
export const roundToNearestInterval = (value, interval) => {
...
| in 3D space.
------------------------------------------ */
export const intersectSphere = (a, b) => {
...
------------------------------------------ */
export const getIndexFromCoords = (x, y, w) => {
  return x + (y * w);
}
...
------------------------------------------ */
export const getCoordsFromIndex = (i, w) => {
  return {
    x: i % w,
    y: Math.floor(i / w)
  }
